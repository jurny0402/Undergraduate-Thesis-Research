...
#Clustering
num_PC = 40
FTC_GEX1 <- RunUMAP(FTC_GEX1, reduction = 'mnn', dims = 1:40, verbose = F)

FTC_GEX1 <- FindNeighbors(FTC_GEX1, reduction = 'mnn', dims = 1:40)

FTC_GEX1 <- FindClusters(FTC_GEX1, resolution = 0.3)

saveRDS(FTC_GEX1, '/home/jurny0402/FTC/code/saved_codes/230408_FTC_GEX_clustered_res0.3_dims1:40.rds')
FTC_GEX1 <- readRDS('/home/jurny0402/FTC/code/saved_codes/230408_FTC_GEX_clustered_res0.3_dims1:40.rds')
...
saveRDS(FTC_GEX1, '/home/jurny0402/FTC/code/saved_codes/230425_FTC_GEX_33clu_dims1:40_prepSCTFindmarkers.rds')

FTC_GEX1 <- readRDS('/home/jurny0402/FTC/code/saved_codes/230425_FTC_GEX_33clu_dims1:40_prepSCTFindmarkers.rds')
#중간저장

allmarkers <- FindAllMarkers(FTC_GEX1, min.diff.pct = 0.1, only.pos = TRUE, logfc.threshold = 0.25, test.use = 'bimod')
write.csv(allmarkers, file = '/home/jurny0402/FTC/code/saved_codes/23042_FTC_GEX1_33clu_dims1:40_allmarkers.csv')
saveRDS(allmarkers, file = '/home/jurny0402/FTC/code/saved_codes/230425_FTC_GEX1_33clu_dims1:40_allmarkers.rds')
allmarkers <- readRDS('/home/jurny0402/FTC/code/saved_codes/230425_FTC_GEX1_33clu_dims1:40_allmarkers.rds')
#중간저장
...
#macrophages
a <- c(3,5,12,17,25,26,31,3,5,12,14,17,22,26,30,31,32,3,5,12,17,25,26,31,253,5,12,17,25,26,31)
...
clust10 <- WhichCells(FTC_GEX1, idents = "TAMs")
clust11 <- WhichCells(FTC_GEX1, idents = "NK")
