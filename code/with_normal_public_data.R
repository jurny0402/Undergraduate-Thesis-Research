...
file_list<-list.files("/home/jurny0402/231116_nor,FTC_seurat/data/GEX")
file_list
file_list <- file_list[-3]
file_list

meta.info=data.table(file_path = file_list)
meta.info$sampleID <- c("FT1", 'FT2', 'FT3', 'FT4', 'FT5', 'N1', 'N2', 'Thy1', 'Thy10', 'Thy4', 'Thy5', 'Thy6', 'Thy7')
DT::datatable(meta.info)
meta.info$file_path
meta.info$sampleID[i]

sample_paths = c("/home/jurny0402/231116_nor,FTC_seurat/data/GEX/FT1_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/FT2_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/FT3_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/FT4_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/FT5_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/N1_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/N2_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/Thy1_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/Thy10_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/Thy4_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/Thy5_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/Thy6_count_matrix.csv",
                 "/home/jurny0402/231116_nor,FTC_seurat/data/GEX/Thy7_count_matrix.csv")
...
saveRDS(FTC_GEX, file = '/home/jurny0402/231116_nor,FTC_seurat/data/231121_FTC_GEX_merged_(beforeqc_noSCT).rds')
FTC_GEX <- readRDS('/home/jurny0402/231116_nor,FTC_seurat/data/231121_FTC_GEX_merged_(beforeqc_noSCT).rds')
#맨 처음 시작시, workspace loading 후 위와 같이 저장된 코드 가져오기

VlnPlot(FTC_GEX, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), pt.size = 0.0, combine = T)
VlnPlot(FTC_GEX, features = "percent.mt", pt.size = 0.1, y.max = 20)

FTC_GEX <- subset(FTC_GEX, subset = percent.mt <= 10 & nFeature_RNA >= 500 & nFeature_RNA <= 10000 & nCount_RNA >= 1000 & nCount_RNA <= 30000)
...
saveRDS(FTC_GEX, file = '/home/jurny0402/231116_nor,FTC_seurat/data/231121_FTC_GEX_SCTranformed_(beforePCA).rds')
FTC_GEX <- readRDS('/home/jurny0402/231116_nor,FTC_seurat/data/231121_FTC_GEX_SCTranformed_(beforePCA).rds')
#중간저장

FTC_GEX <- RunPCA(FTC_GEX)
saveRDS(FTC_GEX, file = '/home/jurny0402/231116_nor,FTC_seurat/data/231121_FTC_GEX_afterpca_(beforeFastMNN)')
FTC_GEX <- readRDS('/home/jurny0402/231116_nor,FTC_seurat/data/231121_FTC_GEX_afterpca_(beforeFastMNN)')
#중간저장
